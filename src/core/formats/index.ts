...
const STUBS: FormatDef[] = [
  ...
  stub('pcap', 'pcap capture', [0xd4, 0xc3, 0xb2, 0xa1], 'Little-endian pcap magic (µs timestamps). The Packet Decoder opens this file directly — frame list, per-layer decode, checksums.'),
  stub('pcap-be', 'pcap capture (big-endian)', [0xa1, 0xb2, 0xc3, 0xd4], 'Big-endian pcap magic. The Packet Decoder opens this file directly.'),
  stub('pcapng', 'pcapng capture', [0x0a, 0x0d, 0x0d, 0x0a], 'pcapng Section Header Block. The Packet Decoder opens this file directly — frame list, per-layer decode, checksums.'),
